...
public class App {
    ...
    public void parseDishData() throws IOException{
        BufferedReader dishData=Files.newBufferedReader(Paths.get("\\Users\\pankaj\\pankaj\\IdeaProject\\shradaswiggy\\data\\dish.csv"));
        String lines=null;
    ...
    public void parseRestroData() throws IOException{
        BufferedReader restroData=Files.newBufferedReader(Paths.get("\\Users\\pankaj\\pankaj\\IdeaProjects\\shradaswiggy\\data\\restro.csv"));
        String lines=null;
